 ...
 * @since 1.0.0
 */
class Resoto_Icons_Control extends \Elementor\Control_Icon {
	...
	/** Enqueue Control Styles/Scripts **/
	public function enqueue() {
		// Styles
		wp_register_style( 'lineicons', RESOTO_VENDORS_URL . 'line-icons/LineIcons.min.css');
